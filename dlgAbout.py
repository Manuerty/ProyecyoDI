...
class Ui_dlg_About(object):
    def setupUi(self, dlg_About):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 3, 781, 369))
    ...
    def retranslateUi(self, dlg_About):
        ...
        self.label_5.setText(_translate("dlg_About", "<html><head/><body><p><a href=\"https://www.youtube.com/shorts/16uJ-jxcKHo\"><span style=\" text-decoration: underline; color:#0000ff;\">Version: 0.0.1</span></a></p></body></html>"))
