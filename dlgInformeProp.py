...
class Ui_dlgInformeProp(object):
    def setupUi(self, dlgInformeProp):
        ...
        dlgInformeProp.resize(372, 243)
        self.widget = QtWidgets.QWidget(parent=dlgInformeProp)
        self.widget.setGeometry(QtCore.QRect(0, 0, 371, 241))
        ...
        self.cmbMuniInforme = QtWidgets.QFontComboBox(parent=self.widget)
        self.cmbMuniInforme.setMinimumSize(QtCore.QSize(225, 0))
        self.cmbMuniInforme.setMaximumSize(QtCore.QSize(300, 16777215))
        self.cmbMuniInforme.setCurrentText("")
        ...
        self.btnGenerarInformeProp = QtWidgets.QPushButton(parent=self.widget)
