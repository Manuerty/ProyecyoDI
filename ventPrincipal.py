...
class Ui_ventPrincipal(object):
    def setupUi(self, ventPrincipal):
        ...
        self.txtAltaCli.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.btnCalendarCli.setMinimumSize(QtCore.QSize(32, 32))
        self.btnCalendarCli.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.gridLayout.addWidget(self.btnCalendarCli, 0, 9, 1, 1)
