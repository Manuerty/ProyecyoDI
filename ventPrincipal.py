...
class Ui_ventPrincipal(object):
    def setupUi(self, ventPrincipal):
        ...
        self.btnBaja = QtWidgets.QPushButton(parent=self.PesClientes)
        self.btnBaja.setMinimumSize(QtCore.QSize(32, 32))
        self.btnBaja.setMaximumSize(QtCore.QSize(32, 32))
        self.btnBaja.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.btnBaja.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\\\templates\\../img/calendar.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btnBaja.setIcon(icon1)
        self.btnBaja.setIconSize(QtCore.QSize(21, 21))
        self.btnBaja.setObjectName("btnBaja")
        self.gridLayout.addWidget(self.btnBaja, 0, 14, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblMuniCli, 5, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.cmbMuniCli, 5, 10, 1, 1)
        ...
        self.lineEdit = QtWidgets.QLineEdit(parent=self.PesClientes)
        ...
        self.gridLayout.addWidget(self.lineEdit, 0, 12, 1, 1)
